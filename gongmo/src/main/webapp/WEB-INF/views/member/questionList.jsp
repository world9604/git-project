	...
	$(function(){
		$(".btn-danger").click(function(event){
			if(confirm("정말 삭제하시겠습니까?") == true){
			 $.ajax({
					url: "/gongmo/member/questionDeleted.action",
					type:"post",
					data:{ questionNo : $(this).attr('data-questionNo') },
	              ...
	              <div class="panel-body">
	                <table class="table table-striped table-bordered table-list">
	                  ...
	                  <c:forEach var="question" items="${questions}">
							...
							<tr>
								<td align="center">
								<button class="btn btn-danger" id="questionDeleted" value="${question.questionNo}" data-questionNo="${question.questionNo}"><em class="fa fa-trash"></em></button>
		                        <%-- <input class="button" type="button"  value="삭제"data-questionNo="${question.questionNo}"/> --%>
		                        </td>
								...
								<td>${question.questionContents}
								</td>
								
								
								<c:forEach var="member" items="${allMember }">
								<c:if test="${member.memberNo == question.memberNo }">
								<td>
								${ member.name }
								</td>
								<td>
